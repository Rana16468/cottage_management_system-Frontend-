          ...
          <div className="flex flex-wrap items-center sm:-mx-3">
            ...
            <div className="w-full md:w-1/2">
              <div className="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                <img
                  src="https://c8.alamy.com/comp/2CWBNJF/illustration-showing-cottage-industry-scene-wool-spinning-and-weaving-on-individual-loom-and-wheel-in-an-english-19th-century-cottage-circa-1820-2CWBNJF.jpg"
                  alt=""
                />
              </div>
            </div>
